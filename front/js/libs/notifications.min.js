...
function notifyGeneral(message, kind, title){
    Lobibox.notify(kind, {
...
function notifyError(message, title){
    ...
    notifyGeneral(message, 'error', title);
}
...
function notifyWarning(message, title){
    ...
    notifyGeneral(message, 'warning', title);
}
...
function notifyInfo(message, title){
    ...
    notifyGeneral(message, 'info', title);
}
...
function notifySuccess(message, title){
    ...
    notifyGeneral(message, 'success', title);
}


//http://lobianijs.com/site/lobibox#notifications
...
<head>
	...
	<script src="../js/controller/SessionController.js"></script>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<span class="navbar-text">
			...
			<button type="button" class="btn btn-danger" onclick="endSession()"><span class="fa fa-sign-out" aria-hidden="true"></span></button>
	    </span>
	</nav>
	<div class="container">
		<div class="row">
